...
int main(int argc, char **argv) {
  po::options_description description("Draw sonar from a bagfile");

  // clang-format off
  description.add_options()("help,h", "Display this help message")
    ("output-topic,t", po::value<string>()->default_value("/drawn_sonar"), "Output topic")
    ...
    ("osd", po::bool_switch()->default_value(true), "Include OSD in output")
    ("output-bag,o", po::value<string>(), "output bagfile")
